...
if (isset($_GET['dl'])) {
    ...
    header('Content-Disposition: attachment; filename=sertifikate_epep1_untuk_'.strtolower(preg_replace("/[^a-zA-Z0-9]+/", "_", $text)). ".jpg");
...
if (!file_exists($path)) {
    ...
    $image1 = imagecreatefromjpeg('epep1.jpg');
